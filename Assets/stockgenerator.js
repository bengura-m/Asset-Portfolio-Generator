        ...
        for (var i = 0; i < response.articles.length; i++) {
          if (newsSourceList.includes(response.articles[i].source.name)) {
            ...
            var collectionItemEl = $(
              "<a href='#modal" +
                i +
                "' class='animated zoomIn collection-item avatar z-depth-2 modal-trigger left-align'>"
            );
            ...
            modalFooterLinkEl
              .addClass(
                "modal-action modal-close waves-effect waves-green btn-flat blue-text cyan lighten-4"
              )
              .text("Read More");
